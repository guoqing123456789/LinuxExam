...
public class UpdateNote extends HttpServlet {
   ...
   final static String URL = "jdbc:mysql://180.76.159.158/linux_final";
   final static String USER = "root";
   final static String PASS = "15380156056Qw*";
   final static String SQL_UPDATE_BOOK = "UPDATE t_notepad SET notepadContent = ? , notepadTime = ? WHERE id=?";
